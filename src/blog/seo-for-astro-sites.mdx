...
description: "a practical walkthrough of the seo setup behind this site: sitemap, og meta, json-ld, rss, canonical urls. no plugins, just the fundamentals."
pubDate: 2025-02-17
...
```yaml
---
title: "deploying astro to aws: the full pipeline"
  ...
  "@graph": [
    ...
    },
    {
      ...
      "sameAs": [
        ...
        "https://www.linkedin.com/in/florian-riquelme-b97756143"
      ],
...
```html
<div class="sr-only">
  <p>Florian Riquelme, Senior Software Engineer. 9+ years
  shipping SaaS platforms, e-commerce, and web apps. Full-stack:
  PHP, React, TypeScript, Go, AWS. Currently at digital-masters
...
```
Homepage: "Florian Riquelme · Senior Engineer · AI Integration"
Blog:     "Blog · Florian Riquelme | Code, Systems & DevOps"
Post:     "deploying astro to aws: the full pipeline · friquelme.dev"
```
